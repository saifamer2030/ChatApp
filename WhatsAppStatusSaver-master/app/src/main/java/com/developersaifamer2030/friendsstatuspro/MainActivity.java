...
import com.developersaifamer2030.friendsstatuspro.NotificationOnlin.MyTokenProfile;
...
import com.developersaifamer2030.friendsstatuspro.data.StatusSavingService;
import com.developersaifamer2030.friendsstatuspro.floatingbutton.FloatingButtonService;
import com.developersaifamer2030.friendsstatuspro.views.FloatAdapter;
import com.developersaifamer2030.friendsstatuspro.views.GlideApp;
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_pictures:
                    ...
                    bottomSelected = getString(R.string.pictures);
                    mergeVideoButton.setVisibility(View.GONE);
                    return true;
                case R.id.navigation_videos:
                    bottomSelected = getString(R.string.videos);
                    statusListAdapter.swapStatus(allVideoPaths);
                    mergeVideoButton.setVisibility(View.GONE);
                    return true;
             /*   case R.id.navigation_profile:
                    bottomSelected = getString(R.string.title_profil);
                    startActivity(new Intent(MainActivity.this,MyTokenProfile.class));
                    mergeVideoButton.setVisibility(View.GONE);
                    return true;*/
            }
            return false;
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (numOfSelectedPic != 0 &&
                    ...
                    String message = numOfSelectedPic == 1 ? getString(R.string.picture_saved) : numOfSelectedPic + " pictures saved";
                    ...
                    String message = numOfSelectedVideos == 1 ? getString(R.string.video_saved) : numOfSelectedVideos + " videos saved";
...
//                    navigation.setSelectedItemId(R.id.navigation_pictures);
                    ...
                    String typeMessage = navigation.getSelectedItemId() == R.id.navigation_pictures ?
                            getString(R.string.picture_selected) : getString(R.string.video_selected);
        ...
        if (receivedIntent != null) {
            ...
            if (link != null) showImagePopup(new Point(0, 2), link);
                ...
                String title = getString(R.string.share_app);
        ...
        mergeVideoButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(numOfSelectedVideos < 2){
                    String typeMessage = getString(R.string.select_video);
                    Snackbar.make(navigation, typeMessage, Snackbar.LENGTH_SHORT).show();
                    return;
                }
...
//                popup.dismiss();
        ...
        switch (requestCode) {
            case MY_PERMISSION_REQUEST_WRITE_STORAGE:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(getBaseContext(), getString(R.string.sorry), Toast.LENGTH_LONG).show();
    ...
    public void startFloating() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && !Settings.canDrawOverlays(this)) {
            Toast.makeText(this, getString(R.string.allow) +
                    getString(R.string.circle), Toast.LENGTH_LONG).show();
    ...
    public class FetchStatusReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (!hasWhatsApp && !hasBusinessWhatsApp) {
                Snackbar.make(mRecyclerView, R.string.sorry_whatsapp, Snackbar.LENGTH_LONG).show();
                ...
                if(receivedStatus != null){
                    ...
                    Snackbar.make(mRecyclerView, R.string.no_status, Snackbar.LENGTH_LONG).show();
                }
